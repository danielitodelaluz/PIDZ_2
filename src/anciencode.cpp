...
const uint8_t PIN_in_V = 19;
const uint8_t PIN_in_L = 18;
const uint8_t PIN_in_T = 20;
const uint8_t PIN_in_R = 21;
...
float measureDistance() {
  ...
  // Serial.println(" DIBFIEFVIEFVZILVEF");
  // Serial.println(distanceCM, 2);
  return distanceCM; // Retourne la distance mesurée
...
void loop() {
  ...
  float currentAltitude = measureDistance()- 11.31f;
